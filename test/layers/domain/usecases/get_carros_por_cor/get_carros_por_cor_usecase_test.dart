...
void main() {
  test('Deve retornar uma isntancia de carro quando passado qualquer cor', () {
  ...
  test('Deve retornar um carro de duas portas quando quando qualquer cor exceto vermelho', () {
    GetCarrosPorCorUseCase useCase = GetCarrosPorCorUseCaseImp(
      GetCarrosPorCorRepositoryImp(GetCarrosPorCorLocalDataSourceImp())
    );
